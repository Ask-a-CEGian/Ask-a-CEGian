...
import 'meeting_list_model.dart';
export 'meeting_list_model.dart';

class MeetingListWidget extends StatefulWidget {
  const MeetingListWidget({super.key});

  @override
  State<MeetingListWidget> createState() => _MeetingListWidgetState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: FutureBuilder<List<MeetingsRecord>>(
                future: queryMeetingsRecordOnce(
                            ...
                            child: ExpandableNotifier(
                              ...
                              child: ExpandablePanel(
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<UsersRecord>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return Text(
                                          'With ${textUsersRecord.displayName}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:
                                ...
                                collapsed: Row(
                                  ...
                                  children: [
                                    Text(
                                      '${listViewMeetingsRecord.startTime?.toString()} to ${listViewMeetingsRecord.endTime?.toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 0.0, 0.0, 10.0),
                                            child: Text(
                                              listViewMeetingsRecord.details,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
