...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn
          ? entryPage ?? const WelcomePageWidget()
      ...
      routes: [
        ...
        FFRoute(
          name: 'MentorForm',
          path: '/mentorForm',
          builder: (context, params) => const MentorFormWidget(),
        ),
        FFRoute(
          name: 'MenteeForm',
          path: '/menteeForm',
          builder: (context, params) => const MenteeFormWidget(),
        ),
        FFRoute(
          name: 'MenteeProfile',
          path: '/menteeProfile',
          builder: (context, params) => const MenteeProfileWidget(),
        ),
        FFRoute(
          name: 'MentorProfile',
          path: '/mentorProfile',
