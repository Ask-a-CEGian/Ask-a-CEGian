...
import 'mentee_home_copy_model.dart';
export 'mentee_home_copy_model.dart';

class MenteeHomeCopyWidget extends StatefulWidget {
  const MenteeHomeCopyWidget({super.key});

  @override
  State<MenteeHomeCopyWidget> createState() => _MenteeHomeCopyWidgetState();
}

class _MenteeHomeCopyWidgetState extends State<MenteeHomeCopyWidget> {
  late MenteeHomeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenteeHomeCopyModel());
                ...
                children: [
                  FutureBuilder<List<MenteeRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MenteeRecord> stackMenteeRecordList = snapshot.data!;

                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final stackMenteeRecord = stackMenteeRecordList.isNotEmpty
